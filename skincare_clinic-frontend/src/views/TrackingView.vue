      ...
      <main class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
          ...
          <div v-if="orderStatus !== null" class="mb-8">
            <div class="space-y-6">
              <div v-for="(stage, index) in stages" :key="index" class="flex items-center">
                <div
                  :class="[
                ...
                >
                  <Check v-if="orderStatus >= index" class="w-5 h-5 text-white" />
                </div>
          ...
          <div v-if="orderStatus !== null" class="mb-8">
            ...
            <div class="bg-gray-50 p-4 rounded-md">
              <p class="mb-2"><strong>Order Number:</strong> #{{ trackingNumber }}</p>
              <p class="mb-2"><strong>Status:</strong> {{ stages[orderStatus] }}</p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        estimatedDelivery: '',
        mockOrders: {
          'TR123': { status: 0, estimatedDelivery: '2023-06-10' },
          'TR456': { status: 1, estimatedDelivery: '2023-06-08' },
          'TR789': { status: 2, estimatedDelivery: '2023-06-06' }
        }
      }
    },
    methods: {
      trackOrder() {
        ...
        if (this.mockOrders[this.trackingNumber]) {
          const order = this.mockOrders[this.trackingNumber]
          this.orderStatus = order.status
          this.estimatedDelivery = this.formatDate(order.estimatedDelivery)
        } else {
